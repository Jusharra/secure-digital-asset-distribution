...
import { Music, Image as ImageIcon, Upload, X, Play, Pause, Loader2 } from 'lucide-react';
...
export function AudioAssetWizard() {
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      setStatus('Creating audio asset...');
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <div className="mb-8 flex items-center">
        ...
        <h2 className="text-xl font-semibold">Create Audio Asset</h2>
      </div>
      ...
      {step === 2 && (
        <div className="space-y-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">Review Audio Asset</h3>
        ...
        <div className="space-y-6">
          <div className="bg-green-50 p-4 rounded-md">
            <p className="text-sm text-green-800">
              Audio asset created successfully! Now upload your source files, master files, and channel-specific files.
            </p>
          </div>
